...
function barbarianLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Barbarian.png')"
  document.querySelector('body').style.color = '#8d6f55'
}
function bardLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Bard.png')"
  document.querySelector('body').style.color = '#862864'
}

function clericLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Cleric.png')"
  document.querySelector('body').style.color = '#6679a4'
}

function druidLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Druid.png')"
  document.querySelector('body').style.color = '#516a4c'
}
function fighterLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Fighter.png')"
  document.querySelector('body').style.color = '#49403b'
}
function monkLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Monk.png')"
  document.querySelector('body').style.color = '#7fadd1'
}

function paladinLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Paladin.png')"
  document.querySelector('body').style.color = '#ce9373'
}

function rangerLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Ranger.png')"
  document.querySelector('body').style.color = '#4d5337'
}
function rogueLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Rogue.png')"
  document.querySelector('body').style.color = '#3f3945'
}

function sorcererLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Sorcerer.png')"
  document.querySelector('body').style.color = '#7b3c4f'
}

function warlockLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Warlock.png')"
  document.querySelector('body').style.color = '#31333f'
}

function wizardLines() {
  document.querySelector('#inner').style.backgroundImage = "url('../dndpicker/css/img/Wizard.png')"
