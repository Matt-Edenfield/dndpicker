...
function bardLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Bard.png')"
  document.querySelector('body').style.color = '#862864'
}

function clericLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Cleric.png')"
  document.querySelector('body').style.color = '#6679a4'
}

function druidLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Druid.png')"
  document.querySelector('body').style.color = '#516a4c'
}
function fighterLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Fighter.png')"
  document.querySelector('body').style.color = '#49403b'
}
function monkLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Monk.png')"
  document.querySelector('body').style.color = '#7fadd1'
}

function paladinLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Paladin.png')"
  document.querySelector('body').style.color = '#ce9373'
}

function rangerLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Ranger.png')"
  document.querySelector('body').style.color = '#4d5337'
}
function rogueLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Rogue.png')"
  document.querySelector('body').style.color = '#3f3945'
}
function sorcererLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Sorcerer.png')"
  document.querySelector('body').style.color = '#7b3c4f'
}

function warlockLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Warlock.png')"
  document.querySelector('body').style.color = '#31333f'
}

function wizardLines() {
  document.querySelector('body').style.backgroundImage = "url('https://github.com/Matt-Edenfield/dndpicker/blob/main/css/img/Wizard.png')"
